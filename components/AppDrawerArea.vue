<template>
  ...
  >
    <v-toolbar color="primary darken-1" dark>
      <img src="../static/images/logo-light.png" height="36" alt="Vue Material Admin Template">
      ...
      >
        <v-list dense expand>
          <template v-for="(item, i) in menus">
            ...
            >
              ...
              <template v-for="(subItem, i) in item.items">
                ...
                <v-list-group v-if="subItem.items" :key="subItem.name" :group="subItem.group" sub-group="sub-group">
                  ...
                  <v-list-item v-for="(grand, i) in subItem.children" :key="i" :to="grand.href? grand.href : null" ripple>
                    <v-list-item-content>
            ...
            <!--top-level link-->
            <v-list-item v-else :to="item.href ? item.href : null" ripple :disabled="item.disabled" :target="item.target" rel="noopener" :key="item.name">
