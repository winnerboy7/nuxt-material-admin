                            ...
                            <v-list dense>
                              <v-list-item>
                                <v-list-item-content>
                                  ...
                                  <v-list-item-subtitle>{{ selectedItem.schId}}</v-list-item-subtitle>
                                </v-list-item-content>
                              </v-list-item>
                              ...
                              <v-list-item>
                                <v-list-item-content>
                                  ...
                                  <v-list-item-subtitle>{{ selectedItem.schName}}</v-list-item-subtitle>
                                </v-list-item-content>
                              </v-list-item>
...
export default {
  ...
  methods: {
    async getArea() {
      ...
      // this.title = `รายชื่อโรงเรียนในสังกัด ${this.area.areaName} (${this.area.areaId})`;
      await await areaService.getById(this.areaId).then(response => {
        [this.area] = response;
        this.title = `รายชื่อโรงเรียนในสังกัด ${this.area.areaName} (${this.area.areaId})`;
        this.form.areaCode = this.areaId;
        this.form.areaName = this.area.areaName;
        this.defaultItem.areaCode = this.areaId;
        this.defaultItem.areaName = this.area.areaName;
      });
    },
    ...
    async getSchools() {
      try {
        ...
        this.schools = await schoolService.getByArea(this.areaId);
