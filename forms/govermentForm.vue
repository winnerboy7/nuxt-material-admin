                    ...
                    <v-row>
                      <v-col cols="4">
                        <v-autocomplete
                          ...
                          data-vv-name="select-personStatus"
                          dense
                        ></v-autocomplete>
                      </v-col>
                      <v-col cols="4">
                        <v-autocomplete
                          ...
                          :items="optionsPhysicalStatus"
                          label="สถานภาพทางกาย"
                          data-vv-name="select-physicalStatus"
                          dense
                        ></v-autocomplete>
                      </v-col>
                      <v-col cols="4">
                        <v-autocomplete
                          ...
                          :items="optionsOutReason"
                          item-value="id"
                          item-text="title"
                          label="สาเหตุที่ออก"
                          data-vv-name="select-outReason"
                          dense
                        ></v-autocomplete>
                      </v-col>
                    </v-row>
                        ...
                        >
                          <template v-slot:activator="{ on, attrs }">
                            <v-text-field
                              ...
                              label="ว/ด/ป เริ่มสัญญาครั้งแรก"
                              prepend-icon="mdi-calendar"
                              readonly
                              v-bind="attrs"
                              v-on="on"
                    ...
                    <v-row>
                      <v-col cols="4">
                        <v-autocomplete
                          ...
                          :items="optionsMovementType"
                          label="ประเภทการเคลื่อนไหวล่าสุด"
                          data-vv-name="select-movementType"
                          dense
                        ></v-autocomplete>
                      </v-col>
                      <v-col cols="4">
                ...
                <v-card-text>
                  <v-container fluid>
                    <v-row>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.salaryFirst"
                          label="ค่าตอบแทนที่บรรจุครั้งแรก"
                          dense
                        ></v-text-field>
                      </v-col>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.salarySeptember"
                          label="ค่าตอบแทนเดือนกันยายน"
                          dense
                        ></v-text-field>
                      </v-col>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.salaryCurrent"
                          label="ค่าตอบแทนปัจจุบัน"
                          dense
                        ></v-text-field>
                      </v-col>
                    </v-row>
                    ...
                    <v-row>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.salaryAdd"
                          label="เงินเพิ่มค่าครองชีพ"
                          dense
                        ></v-text-field>
                      </v-col>
                      <v-col cols="4">
                        <v-text-field
                          ...
                          label="เงินสมทบกองทุนประกันสังคม 5%"
                          dense
                        ></v-text-field>
                      </v-col>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.compensationFund"
                          label="เงินสมทบกองทุนเงินทดแทน ร้อยละ 2"
                          dense
                        ></v-text-field>
                      </v-col>
                    </v-row>
                    ...
                    <v-row>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.riskPremium"
                          label="เงินเบี้ยเสี่ยงภัย (เฉพาะ จชต.)"
                          dense
                        ></v-text-field>
                      </v-col>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.salaryPercent"
                          label="ร้อยละที่ได้รับการเลื่อนค่าตอบแทน"
                          dense
                        ></v-text-field>
                      </v-col>
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.scoreKPI"
...
export default {
  ...
  data: () => ({
    ...
    optionsPositionStatus: [
      { id: "1", title: "มีคนถือครอง" },
      { id: "2", title: "ว่างมีเงิน" },
      { id: "3", title: "ว่างไม่มีเงิน" },
      { id: "4", title: "ว่างอยู่ระหว่างสรรหา" },
      { id: "5", title: "ว่างรายงานส่งคืน สพฐ." }
    ],
    optionsAddPosition: [],
    ...
    optionsMovementType: ["การต่อสัญญา", "ทำสัญญาครั้งแรก"],
    optionsPhysicalStatus: ["ปกติ", "ทุพพลภาพ"],
    optionsOutReason: [
      { id: "1", title: "ไปรับราชการ" },
      { id: "2", title: "ไปทำงานเอกชน" },
      { id: "3", title: "ประกอบอาชีพอิสระ" },
      { id: "4", title: "ทุพพลภาพ" },
      { id: "5", title: "ไม่ผ่านการประเมิน" },
      { id: "6", title: "อื่น ๆ" }
    ]
  }),
