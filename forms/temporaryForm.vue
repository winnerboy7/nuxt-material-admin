        ...
        <v-card-text>
          <v-tabs background-color="light-blue darken-3" dark vertical>
            ...
            <v-tab-item>
              <v-card class="elevation-3">
                <v-toolbar dark dense color="light-blue darken-1">
                  <v-toolbar-title>ข้อมูลตำแหน่ง/เงินเดือน</v-toolbar-title>
                </v-toolbar>
                <v-card-text>
                  <v-container fluid>
                    <v-row>
                    ...
                    <v-row>
                      ...
                      <v-col cols="4">
                        <v-text-field
                          v-model="form.budgetPlan"
                          label="ผลผลิต/แผนงาน/โครงการ"
                          dense
                        ></v-text-field>
                      </v-col>
                    </v-row>
                    ...
                    <v-row>
                      ...
                      <v-col cols="4">
                        <v-autocomplete
                          ...
                          label="ลักษณะการจ้าง"
                          data-vv-name="select-contractType"
                          dense
                        ></v-autocomplete>
                      </v-col>
                      <!-- <v-col cols="4">
                    ...
                    <v-row>
                      ...
                      <v-col cols="4">
                        <v-autocomplete
                          ...
                          :items="optionsSalaryType"
                          label="ประเภทเงินงบประมาณ"
                          data-vv-name="select-salaryType"
                          dense
                        ></v-autocomplete>
                      </v-col>
                    </v-row>
...
export default {
  ...
  data: () => ({
    ...
    optionsContractType: ["จ้างใหม่", "ต่อเนื่อง"],
    optionsSalaryType: ["งบดำเนินงาน", "รายได้สถานศึกษา"]
  }),
